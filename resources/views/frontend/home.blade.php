    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="{{ asset('frontend/images/saving-img.png')}}" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="img_container">
              <div class="img-box">
                <img src="{{ asset('frontend/images/gifts.png')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-7">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-5 px-0">
          <form action="{{ url('/contact') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
              <input type="text" class="message-box" placeholder="Message" name='massege' />
            </div>
            <div class="d-flex ">
              <button type="submit">
                SEND
